...
public class PeliculaService {
	...
	public void addPelicula(Pelicula pelicula) throws SQLException, ClassNotFoundException {
		...
		Connection con = conexion.getConnection();
		String sql = "insert into peliculas (titulo,genero,duracion,director,reparto,sinopsis)"
				+ "VALUES (?,?,?,?,?,?)";
	...
	public void updatePelicula(Pelicula pelicula) throws SQLException, ClassNotFoundException {
		...
		Connection con = conexion.getConnection();
		String sql = "UPDATE peliculas SET titulo=?, genero=?, duracion=?, director=?, reparto=?, sinopsis=?"
				+ "WHERE id=?";
